...
public class Ball {
	...
	public Ball(float _x, float _y, float _radius, float _speed, float _angleInDegree, char symbol) {
		this.x = _x;
		this.y = _y;
		this.speedX = (float)(_speed * Math.cos(Math.toRadians(_angleInDegree)));
		this.speedY = (float)(_speed * Math.sin(Math.toRadians(_angleInDegree)));
	...
	public void draw(Graphics g) {
			...
			g.drawString(String.valueOf(this.symbol), (int)(x-radius/4), (int)(y+radius/4));
	}
